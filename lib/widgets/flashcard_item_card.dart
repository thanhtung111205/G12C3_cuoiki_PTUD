              ...
              children: <Widget>[
                ...
                if (widget.card.phonetic != null && widget.card.phonetic!.isNotEmpty) ...[
                  ...
                  Text(
                    ...
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(fontSize: 16, color: accent, fontStyle: FontStyle.italic, fontWeight: FontWeight.w500),
                  ),
                ],
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              ...
              maxLines: 2,
              overflow: TextOverflow.ellipsis,
              style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: primaryText),
            ),
